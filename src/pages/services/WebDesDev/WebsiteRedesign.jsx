  ...
  const services = [
    {
      ...
      desc: "Modern, visually appealing designs that enhance user experience and engagement.",
    },
    {
      icon: <Zap size={22} />,
      title: "Performance Optimization",
      desc: "Improve loading speed and overall performance for better SEO and user retention.",
    },
    {
      icon: <TrendingUp size={22} />,
      title: "Conversion Optimization",
      desc: "Redesign layouts and funnels to increase leads, sales, and conversions.",
    },
    {
      icon: <RefreshCcw size={22} />,
      title: "Content & Structure Revamp",
      desc: "Reorganize content for clarity, SEO, and better user flow.",
    },
    {
      icon: <ShieldCheck size={22} />,
      title: "Security & Updates",
      desc: "Upgrade your website with modern security standards and latest technologies.",
    },
  ];
      ...
      <div className="bg-gradient-to-b from-[#0f172a] via-[#0b1120] to-black text-white">
        ...
        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 text-center">
            <div className="bg-white/5 p-10 rounded-2xl border border-white/10">
              ...
              <p className="text-gray-400 mt-2">Faster performance</p>
            </div>

            <div className="bg-white/5 p-10 rounded-2xl border border-white/10">
              <h3 className="text-4xl font-bold text-blue-500">3X</h3>
              <p className="text-gray-400 mt-2">More engagement</p>
            </div>

            <div className="bg-white/5 p-10 rounded-2xl border border-white/10">
              <h3 className="text-4xl font-bold text-blue-500">↑</h3>
              <p className="text-gray-400 mt-2">Higher conversions</p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center py-28 px-6">
          ...
          <p className="text-gray-400 mt-6 max-w-xl mx-auto">
            Let’s redesign your website into a powerful business asset that drives results.
          </p>

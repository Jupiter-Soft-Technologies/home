...
export default function EdTechAppDevelopment() {
  ...
  const services = [
    {
      ...
      desc: "Build scalable LMS platforms for structured courses, lessons, and progress tracking.",
    },
    {
      icon: <Video size={22} />,
      title: "Live Classes & Video Integration",
      desc: "Enable live classes, recorded sessions, and interactive learning experiences.",
    },
    {
      icon: <Users size={22} />,
      title: "Student & Teacher Dashboards",
      desc: "Dedicated dashboards for students and instructors with personalized insights.",
    },
    {
      icon: <Smartphone size={22} />,
      title: "Mobile-First Learning Apps",
      desc: "Seamless mobile apps designed for accessibility and engagement.",
    },
    {
      icon: <BarChart3 size={22} />,
      title: "Analytics & Progress Tracking",
      desc: "Monitor performance, engagement, and learning outcomes with detailed analytics.",
    },
  ];

  const benefits = [
    "Scalable online education platform",
    "Monetization through courses & subscriptions",
  ...
  const process = [
    "Requirement analysis & platform strategy",
    "UI/UX design for learners",
      ...
      <div className="bg-gradient-to-b from-[#0f172a] via-[#0b1120] to-black text-white">
        ...
        <section className="py-32 text-center px-6 relative overflow-hidden">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto mt-6 text-lg">
            Build powerful education apps that deliver engaging learning experiences,
            manage courses efficiently, and scale your online education business.
          </p>
        ...
        <section className="py-24 px-6">
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 text-center">
            ...
            <div className="bg-white/5 p-10 rounded-2xl border border-white/10">
              ...
              <p className="text-gray-400 mt-2">Engagement increase</p>
            </div>

            <div className="bg-white/5 p-10 rounded-2xl border border-white/10">
              <h3 className="text-4xl font-bold text-blue-500">Scalable</h3>
              <p className="text-gray-400 mt-2">Growth-ready platforms</p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center py-28 px-6">
          ...
          <p className="text-gray-400 mt-6 max-w-xl mx-auto">
            Let’s create an education app that delivers value, engagement, and growth.
          </p>

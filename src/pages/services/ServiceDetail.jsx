...
//               <p className={`mt-6 text-xl ${accentMap[service.accent]}`}>
//                 {study.result}
//               </p>
//             </div>
//           ))}
...
//               <p className={`text-4xl font-bold mt-6 ${accentMap[service.accent]}`}>
//                 ${i === 0 ? "499" : i === 1 ? "999" : "1999"}
//               </p>

//               <p className="text-gray-400 mt-4">Monthly Plan</p>
...
//         {faqs.map((faq, i) => (
//           <div key={faq.question} className="mb-6 border-b border-white/10 pb-6">
//             <button
